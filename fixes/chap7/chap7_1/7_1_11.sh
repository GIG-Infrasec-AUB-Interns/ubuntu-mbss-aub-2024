...
# 7.1.11 [REMEDIATION] Ensure world writable files and directories are secured

{ 
  echo "[REMEDIATION] Ensuring world writable files and directories are secured (7.1.11)..."
  l_smask='01000' 
