...
# 7.2.10 [REMEDIATION] Ensure local interactive user dot files access is configured

{ 
  echo "[REMEDIATION] Ensuring local interactive user dot files access is configured (7.2.10)..."
