...
# 7.2.9 [REMEDIATION] Ensure local interactive user home directories are configured

{ 
  echo "[REMEDIATION] Ensuring local interactive user home directories are configured (7.2.9)..."
  l_output2="" 
