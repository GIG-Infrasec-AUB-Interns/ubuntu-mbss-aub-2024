...

{
    ...
    if [[ -z "$findmnt_output" ]]; then
        ...
        read -p "Run remediation script for Test 1.1.2.1.2? (Y/N): " ANSWER
        case "$ANSWER" in
            [Yy]*)
                echo "Commencing remediation for Test 1.1.2.1.2..."
                
                FIXES_SCRIPT="$(realpath fixes/chap1/chap1_1/chap1_1_2/chap1_1_2_1/1_1_2_1_2.sh)"
