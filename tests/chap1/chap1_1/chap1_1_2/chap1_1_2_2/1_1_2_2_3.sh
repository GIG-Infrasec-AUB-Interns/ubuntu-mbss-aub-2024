...

{
    ...
    if [[ -z "$findmnt_output" ]]; then
        ...
        read -p "Run remediation script for Test 1.1.2.2.3? (Y/N): " ANSWER
        case "$ANSWER" in
            [Yy]*)
                echo "Commencing remediation for Test 1.1.2.2.3..."
                
                FIXES_SCRIPT="$(realpath fixes/chap1/chap1_1/chap1_1_2/chap1_1_2_1/1_1_2_2_3.sh)"
