...

{
    ...
    if [ -z "$l_output2" ]; then
        ...
        #Remediation 
        read -p "Run remediation script for Test 3.2.1? (Y/N): " ANSWER
        case "$ANSWER" in
            [Yy]*)
                echo "Commencing remediation for Test 3.2.1..."
                # Resolve absolute path to fixes/chap3/chap3_2/chap3_2_1.sh
                FIXES_SCRIPT="$(realpath fixes/chap3/chap3_2/chap3_2_1.sh)"
